...
// Taken from https://github.com/MemoryLeakHub/Water2D-Unity
public class WaterSpring : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D other) {
        if (other.gameObject.CompareTag("Pen") || other.gameObject.CompareTag("Player") || other.gameObject.CompareTag("TempObj")) {
